...
export const Bubble = ({ text, isDollarSign = false }: BubbleProps) => {
  return (
    <div
      className={cn(
        ...
        {
          'bg-[#8BC4FF] after:left-7 after:border-t-[#8BC4FF] lg:bg-white lg:after:border-t-white': !isDollarSign,
      ...
      <p
        className={cn('text-lg font-black', {
          'text-white lg:text-[#40E2E8]': !isDollarSign,
